...
export default {
  // display orphanages list controller
  ...
  // display one orphanage controller
  ...
  async create(request: Request, response: Response) {
    ...
    const requestImages = request.files as Express.Multer.File[]; //forces variable to be an array
